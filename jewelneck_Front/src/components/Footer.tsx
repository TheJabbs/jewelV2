      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-display font-medium">JewelNeck</h3>
            <p className="text-muted-foreground text-sm">
              Experience the elegance of fine jewelry with our innovative AR technology.
            </p>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">Collections</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Necklaces</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Pendants</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Chains</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Sizing Guide</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} JewelNeck. All rights reserved.
          </p>
